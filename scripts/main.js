...
function FriendlyChat() {
  ...
  this.pSub = document.getElementById('pSub');
...
FriendlyChat.prototype.saveImageMessage = function(event) {
  ...
  if (this.checkSignedInWithMessage()) {
    ...
    this.productRef = this.database.ref("ShortProducts");
    this.productRef.push({
      productID: this.messageInput.value,
      productName: this.pName.value,
      productSubDetail: this.pSub.value,
      productPrice: this.pPrice.value,
      productMainImage: FriendlyChat.LOADING_IMAGE_URL
    }).then(function(data) {

      // Upload the image to Firebase Storage.
      var uploadTask = this.storage.ref('ShortProductMainImage/' + this.messageInput.value + '_' + file.name)
